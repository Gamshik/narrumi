...
<!-- For checkpoint task examples and patterns, see @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/checkpoints.md -->
...
See `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
