...
<required_reading>
@D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/ai-frameworks.md
@D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/ProgrammingAndProjects/learn-english/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/ProgrammingAndProjects/learn-english/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/ProgrammingAndProjects/learn-english/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/ProgrammingAndProjects/learn-english/.codex/agents/gsd-eval-planner.md for instructions.
