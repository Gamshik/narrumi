...
- **Global scope**: `D:/ProgrammingAndProjects/learn-english/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/ProgrammingAndProjects/learn-english/.codex/notes/`)
...
2. Glob `D:/ProgrammingAndProjects/learn-english/.codex/notes/*.md` (if directory exists) — global notes
...
Global (D:/ProgrammingAndProjects/learn-english/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/ProgrammingAndProjects/learn-english/.codex/notes/` — works in any directory
