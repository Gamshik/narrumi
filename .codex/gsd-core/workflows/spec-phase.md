...
ones). Reference: @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/ProgrammingAndProjects/learn-english/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/ProgrammingAndProjects/learn-english/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/templates/spec.md.
