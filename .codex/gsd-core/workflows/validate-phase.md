...
```
Agent(
  prompt="Read D:/ProgrammingAndProjects/learn-english/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/templates/VALIDATION.md`
