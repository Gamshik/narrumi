...
```
Agent(
  prompt="Read D:/ProgrammingAndProjects/learn-english/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/templates/SECURITY.md`
