...
INSTALL_JS_GLOBAL="D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
