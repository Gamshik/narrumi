...
<template>
@D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/workflows/transition.md`.
...
- Follow @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/workflows/diagnose-issues.md
