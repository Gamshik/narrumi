...
Key references:
- @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/ui-brand.md (display patterns)
- @D:/ProgrammingAndProjects/learn-english/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/USER-PROFILE.md" "D:/ProgrammingAndProjects/learn-english/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/user-profiling.md`
...
Reference: @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/ProgrammingAndProjects/learn-english/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at D:/ProgrammingAndProjects/learn-english/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/ProgrammingAndProjects/learn-english/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="D:/ProgrammingAndProjects/learn-english/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   D:/ProgrammingAndProjects/learn-english/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.codex/AGENTS.md>
  ✓ Global AGENTS.md        D:/ProgrammingAndProjects/learn-english/.codex/AGENTS.md
```
