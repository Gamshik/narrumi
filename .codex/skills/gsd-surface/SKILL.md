...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/ProgrammingAndProjects/learn-english/.codex/.gsd-surface.json`
(sibling to `D:/ProgrammingAndProjects/learn-english/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/ProgrammingAndProjects/learn-english/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`D:/ProgrammingAndProjects/learn-english/.codex/skills`).
...
`D:/ProgrammingAndProjects/learn-english/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/ProgrammingAndProjects/learn-english/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/ProgrammingAndProjects/learn-english/.codex/.gsd-surface.json`
Install profile marker: `D:/ProgrammingAndProjects/learn-english/.codex/.gsd-profile`
Skill dirs: `D:/ProgrammingAndProjects/learn-english/.codex/skills/gsd-*/`
Engine module: `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
