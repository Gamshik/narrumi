...
**Verification depth scales with `asvs_level`** (see @D:/ProgrammingAndProjects/learn-english/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
