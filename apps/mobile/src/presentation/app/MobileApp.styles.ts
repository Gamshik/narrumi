...
function createAppStylesImpl(colors: AppColors) {
  return StyleSheet.create({
    ...
    tabBarBlur: { position: "absolute", top: 0, left: 0, right: 0, bottom: 0 },
    tabBarFill: {
      position: "absolute",
      top: 0,
      left: 0,
    ...
    tabIconLift: { transform: [{ scale: 1.06 }] },
    tabGlyph: { fontSize: 19, color: colors.labelSecondary },
    tabGlyphActive: { color: "#ffffff" },
    tabLabel: {
      fontFamily: fontFamilies.display,
      fontSize: 10,
      color: colors.labelSecondary,
