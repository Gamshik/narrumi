...
2. **Language, Continuity & Safety Validator:** Independently reviews each creative candidate for CEFR fit, grammar complexity, word usage, continuity, learner-action and scenario alignment, repetition, participation mode, logical closure, choice diversity, safety, copyright constraints, and output shape before the user sees it. It does not choose a preferred completion turn inside the valid 5-9 window.
