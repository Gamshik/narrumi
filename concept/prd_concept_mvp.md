...
2. **Language, Continuity & Safety Validator:** Independently reviews each creative candidate for CEFR fit, concrete grammar and sentence-construction errors, part-of-speech-aware Story Word usage, continuity, learner-action and scenario alignment, repetition, participation mode, logical closure, meaningful continuation development, choice diversity, safety, copyright constraints, and output shape before the user sees it. It does not choose a preferred completion turn inside the valid 5-9 window.
